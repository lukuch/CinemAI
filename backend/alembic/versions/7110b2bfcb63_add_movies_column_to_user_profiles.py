...
def upgrade() -> None:
    ...
    op.alter_column(
        "user_profiles", "clusters", existing_type=postgresql.JSON(astext_type=sa.Text()), type_=sa.Text(), nullable=True
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "user_profiles", "clusters", existing_type=sa.Text(), type_=postgresql.JSON(astext_type=sa.Text()), nullable=False
    )
